...
export const EventCard: React.FC<EventCardProps> = ({ event }) => {
  ...
  return (
    <div
      id={event.id}
      className={`w-full cyber-panel rounded-2xl p-6 sm:p-7 flex flex-col justify-between border transition-all duration-300 group relative overflow-hidden bg-gradient-to-b from-[#0e1626]/90 via-[#0a101d]/95 to-[#060a12] hover:-translate-y-1 ${
        isOngoing
          ? "border-emerald-500/40 hover:border-emerald-400 hover:shadow-[0_0_30px_rgba(16,185,129,0.2)] shadow-[0_0_15px_rgba(16,185,129,0.08)]"
          : "border-cyan-500/20 hover:border-cyan-400/60 hover:shadow-[0_0_30px_rgba(0,240,255,0.15)]"
      }`}
    >
      ...
      <div className="flex items-center justify-start gap-3 mb-4">
        ...
        <span
          className={`px-2.5 py-1 rounded font-mono text-[11px] uppercase tracking-wider backdrop-blur-md flex items-center gap-1.5 ${
            isOngoing
              ? "bg-emerald-500/15 text-emerald-300 border border-emerald-400/50 shadow-[0_0_10px_rgba(16,185,129,0.2)]"
              : isUpcoming
